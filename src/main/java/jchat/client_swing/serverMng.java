...
public class serverMng extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setMaximumRowCount(255);

        jLabel3.setBackground(new java.awt.Color(51, 51, 51));
        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 204, 204));
        jLabel3.setText("Saved connections");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(serverMng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
